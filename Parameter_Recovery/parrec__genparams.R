...
#Sample size / number of clusters / noise 
#seed (set as desired)
seed1 = 90053
seed2 = 90053

scl = as.numeric( commandArgs(trailingOnly = TRUE) )
...
file_name = paste( "trueparams", scl, ".RData", sep="" )
save(pars, parnames, nobslist, nobsnames, file=file_name)
